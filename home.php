...
<nav class="navbar navbar-expand-lg hephnav">
        ...
        <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item active">
                    <a class="nav-link font-weight-bold contact" href="contact">Contact</a>
                </li>
            </ul>
            <form method="post">

            <img class="profile-circle" src="<?php echo $imageURL; ?>" alt="User Image"/><span class=""></span>
            <small class=" font-weight-bold position-relative mr-1" style="font-size: 14px; top: 1px; color:#298b92;"><?php echo $user['name'] ?> </small>	
